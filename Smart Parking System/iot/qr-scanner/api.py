...
async def process_scan(
    ...
    """
    Receives QR string/image and car image.
    1. Forwards QR string to Backend Server.
    2. Forwards car image to ANPR Camera.
    """
    ...
    return {"status": "success", "message": "QR verified and image forwarded to camera."}
